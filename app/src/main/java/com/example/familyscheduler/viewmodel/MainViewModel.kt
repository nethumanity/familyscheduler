...
class MainViewModel(
    ...
    fun generateFlexResolveProposalsForReason(
        ...
        return offsets.flatMap { offset ->
            ...
            persons.mapNotNull { person ->
                ...
                // ① 移動元にその人が存在するか
                val candidateSlot = _slots.value.find {
    ...
    private fun canAssign(
        ...
        val slot = slots.value.find { it.person == person && it.index == index }
            ?: return false
